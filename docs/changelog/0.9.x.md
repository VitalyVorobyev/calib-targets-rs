...
configuration. See
[`docs/algorithms/chess-corners-0.10-impact.md`](docs/algorithms/chess-corners-0.10-impact.md)
...
- The 0.9-era algorithm work (`OrientationMethod` plumbing,
  ...
  bench matrix is in `docs/algorithms/chess-corners-0.10-impact.md`. The
