...
configuration. The strict-dominance check that keeps the workspace
default on `RingFit` is documented in
[`docs/algorithms/diskfit-antipodal-sector.md`](docs/algorithms/diskfit-antipodal-sector.md)
(the 0.8 → 0.10 integration report that held the original bench matrix
...
- The 0.9-era algorithm work (`OrientationMethod` plumbing,
  ...
  did not trigger); see `docs/algorithms/diskfit-antipodal-sector.md`.
