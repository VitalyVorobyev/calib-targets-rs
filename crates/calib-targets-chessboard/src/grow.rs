...
//! [`projective_grid_next::detect::advanced::square::grow`]. This module supplies the
//! chessboard-specific
//! [`SquareAttachPolicy`](projective_grid_next::detect::advanced::square::grow::SquareAttachPolicy)
...
use nalgebra::Point2;
use projective_grid_next::detect::advanced::square::grow as pg_grow;
...
/// by [`projective_grid_next::detect::advanced::square::extension::extend_via_local_homography`]'s
