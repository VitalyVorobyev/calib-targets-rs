...
//! global-H and local-H passes: optional label gate, ambiguity check,
//! [`SquareAttachPolicy::accept_candidate`], and [`SquareAttachPolicy::edge_ok`].
...
use crate::detect::advanced::square::grow::{
    Admit, GrowResult, LabelledNeighbour, SquareAttachPolicy,
};
use nalgebra::Point2;
...
/// so the policy can measure the residual.
