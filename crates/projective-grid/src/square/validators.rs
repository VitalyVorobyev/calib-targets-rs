//! Ready-to-use [`NeighborValidator`] implementations for square grids.
//!
//! | Validator | PointData | Use case |
//! |-----------|-----------|----------|
//! | [`XJunctionValidator`] | `F` (orientation mod π) | ChESS corners, chessboard X-junctions |
//! | [`SpatialSquareValidator`] | `()` | Unoriented features on a square lattice |

use crate::float_helpers::{lit, rem_euclid};
...
// ---------------------------------------------------------------------------
// Geometry helpers (private to the square validators)
// ---------------------------------------------------------------------------
