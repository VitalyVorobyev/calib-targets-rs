...
//! 2-means helpers.
//!
//! These primitives are pattern-agnostic pieces of the
//! **global grid-direction** clustering stage. The [`super`] module
//! owns the histogram-accumulation step (iterates oriented features,
//! reads per-axis `(angle, sigma, strength)`) and the final
//! per-feature label assignment; this module provides the generic
//! math underneath:
//!
