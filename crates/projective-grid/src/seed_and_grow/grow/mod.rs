...
//! - this module — the BFS core, candidate search / ambiguity resolution,
//!   and boundary-cell decision, all re-exporting the above so existing
//!   `crate::seed_and_grow::grow::*` paths are unchanged.
