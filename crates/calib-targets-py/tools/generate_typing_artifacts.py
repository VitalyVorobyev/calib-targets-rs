...
def _render_core_stub(
    ...
    return_types = {
        ...
        "chessboard_sweep_default": "list[dict[str, Any]]",
        "charuco_sweep_for_board": "list[dict[str, Any]]",
        "marker_board_sweep_for_board": "list[dict[str, Any]]",
        "puzzleboard_sweep_for_board": "list[dict[str, Any]]",
