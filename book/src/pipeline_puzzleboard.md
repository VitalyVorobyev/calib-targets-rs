...
carries a midpoint dot, and the dot pattern uniquely identifies a
...
- **`min_window`** (default `7`) — the uniqueness floor; rarely changed, and
  lowering it trades misses for the risk of a wrong absolute label.
