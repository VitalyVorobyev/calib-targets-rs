...
This document collects every breaking change in the current release for
...
It mirrors the [Migration chapter](book/src/migration.md) in the book.

The changes fall into five themes:
